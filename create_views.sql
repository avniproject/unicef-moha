...
SELECT individual.id                                                                                          "Ind.Id",
       ...
       get_coded_string_value(
                  programEnrolment.observations -> '(9cee1acc-9323-46cf-8167-d67326fbd8ed)', concepts.map)::TEXT                 as "Enl.Form filled in",
       ...
       get_coded_string_value(
                  programEnrolment.observations -> '(9e0e21b0-e5c2-406a-8da6-a11a78d65329)', concepts.map)::TEXT                 as "Enl.Timing of death in pregnancy",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'c922c13c-1fa2-42dd-a7e8-d234b0324870', concepts.map)::TEXT                 as "Enc.Religion",
       get_coded_string_value(
                  programEncounter.observations -> '61ab6413-5c6a-4512-ab6e-7d5cd1439569', concepts.map)::TEXT                 as "Enc.Caste Category",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '9e0e21b0-e5c2-406a-8da6-a11a78d65329', concepts.map)::TEXT                 as "Enc.Timing of death in pregnancy",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '05dbdea3-2d60-4c18-9d53-57c01bd0a05b', concepts.map)::TEXT                 as "Enc.Previous abortion",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '9813a8c2-b49c-45c5-94bb-6abdde0c8900', concepts.map)::TEXT                  as "Enc.Delay in seeking care",
       (programEncounter.observations ->> 'f0bf309c-7970-4027-ad59-246d541822c0')::TEXT                    as "Enc.Other cause of delay in seeking care",
       get_coded_string_value(
                  programEncounter.observations -> 'b74b985b-9717-4ea6-9e9a-0a47b6cc220f', concepts.map)::TEXT                  as "Enc.Delay in reaching health facility",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'bd248784-7978-4f8f-bd79-8dd3064d2847', concepts.map)::TEXT                  as "Enc.Delay in receiving adequate care in facility",
...
SELECT individual.id                                                                                          "Ind.Id",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '77209dcc-a49d-40f1-929a-4ef95b4f085b', concepts.map)::TEXT                 as "Enc.Medico-legal admission",
       (programEncounter.observations ->> '8b8a1118-f2be-4f3d-ace7-8f7a16164c00')::TEXT                    as "Enc.Complete Address",
       (programEncounter.observations ->> '271edc25-bfdc-4eb9-85f1-16fafd5b28e1')::TEXT                    as "Enc.Contact/Mobile No",
       get_coded_string_value(
                  programEncounter.observations -> '39595a16-a9c6-49a5-a42b-3f462607058c', concepts.map)::TEXT                 as "Enc.Education",
       get_coded_string_value(
                  programEncounter.observations -> 'cd6e5e69-fa7a-4eb8-9b7c-96735ff7fdf1', concepts.map)::TEXT                 as "Enc.Below Poverty Line",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '090bb4ab-7ba3-4aab-a040-acef52c75ed3', concepts.map)::TEXT                 as "Enc.Was mother admitted to ICU?",
       (programEncounter.observations ->> '2f6e79b3-eafa-4101-b01a-a18636fc21a7')::TEXT                    as "Enc.Duration of ICU Stay",
       get_coded_string_value(
                  programEncounter.observations -> '91df8f1c-8029-414c-9581-7b3e01f1e724', concepts.map)::TEXT                 as "Enc.Reason for mother not being admitted to the ICU",
       get_coded_string_value(
                  programEncounter.observations -> '2aee3472-3034-4a5e-abf5-8100c5890f3f', concepts.map)::TEXT                 as "Enc.Outcome of pregnancy",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'c8ca801c-e61c-4e95-9f78-501fc1d03ad7', concepts.map)::TEXT                 as "Enc.Period of gestation (live/still birth)",
       get_coded_string_value(
                  programEncounter.observations -> '772cb5b7-3187-448b-9136-6c1b487937e1', concepts.map)::TEXT                 as "Enc.Period of gestation (non live/still birth)",
       get_coded_string_value(
                  programEncounter.observations -> '11d4816d-4253-4dda-92fc-16f2d2704e5a', concepts.map)::TEXT                 as "Enc.Condition on Admission",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'ca5c3e67-2d06-4947-b0be-8565a62eb39d', concepts.map)::TEXT                 as "Enc.Type of transport used from home",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '7fd6dfff-4e8e-4412-9f21-c6c9e7a322aa', concepts.map)::TEXT                  as "Enc.Who attended at Facility 1?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'e2da4703-2531-4dd1-811f-27d4fb4fc8b1', concepts.map)::TEXT                 as "Enc.Type of facility referred at Facility 1",
       (programEncounter.observations ->> '1b36a513-0f93-4fbb-bd91-4d7079b2c655')::DATE                    as "Enc.Date of referral from Facility 1",
       get_coded_string_value(
                  programEncounter.observations -> '5b9df7c4-4493-4a11-9b39-c534bcdad60d', concepts.map)::TEXT                  as "Enc.Reason for referral from Facility 1",
       (programEncounter.observations ->> '685637fa-94b9-4bbb-b1a0-3ad50176aa8e')::TEXT                    as "Enc.Other reason for referral from Facility 1",
       get_coded_string_value(
                  programEncounter.observations -> 'a2576f78-9099-42b0-9e52-0c741675e1c7', concepts.map)::TEXT                 as "Enc.Referral Slip from Facility 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '0ee7403c-85c3-4f8c-b5b3-ce9678ca28d9', concepts.map)::TEXT                 as "Enc.Type of transport used from Facility 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'e751fcb0-d8c3-47fc-8d39-d61feff047d2', concepts.map)::TEXT                  as "Enc.Treatment given at Facility 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '582ddda2-e720-4ce8-8891-8246a68f3dc5', concepts.map)::TEXT                  as "Enc.Who attended at Facility 2?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '949ffb3a-254d-40be-be16-e36bf730764d', concepts.map)::TEXT                 as "Enc.Type of facility referred at Facility 2",
       (programEncounter.observations ->> '6239db6f-0dd1-4c81-b131-5f6c194ccd2f')::DATE                    as "Enc.Date of referral from Facility 2",
       get_coded_string_value(
                  programEncounter.observations -> '30b9950f-e78c-46d1-864b-b8a4cef0a965', concepts.map)::TEXT                  as "Enc.Reason for referral from Facility 2",
       (programEncounter.observations ->> '393fbfb7-df6d-4c30-89c7-e6b338bdbc57')::TEXT                    as "Enc.Other reason for referral from Facility 2",
       get_coded_string_value(
                  programEncounter.observations -> '76468e15-0ae4-4cb7-9eaf-756ea4256b4b', concepts.map)::TEXT                 as "Enc.Referral Slip from Facility 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '2a451e3c-b803-477b-a518-c4a2ddde9928', concepts.map)::TEXT                 as "Enc.Type of transport used from Facility 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '70f354df-5846-4e7d-aec2-661bd2aba924', concepts.map)::TEXT                  as "Enc.Treatment given at Facility 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'a4233145-2938-4377-aa3e-0f92cb2eff7a', concepts.map)::TEXT                  as "Enc.Who attended at Facility 3?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '6950dc15-92c7-4dd0-8625-82a12500c3d8', concepts.map)::TEXT                 as "Enc.Type of facility referred at Facility 3",
       (programEncounter.observations ->> '31aa2e89-2e6e-48ea-a9b6-4a14de360547')::DATE                    as "Enc.Date of referral from Facility 3",
       get_coded_string_value(
                  programEncounter.observations -> '27daf271-29b8-4402-9ce6-abfbd4ae63d9', concepts.map)::TEXT                  as "Enc.Reason for referral from Facility 3",
       (programEncounter.observations ->> 'e99e949d-dc19-4a27-b27a-48bbc92f3b30')::TEXT                    as "Enc.Other reason for referral from Facility 3",
       get_coded_string_value(
                  programEncounter.observations -> '4d547c43-136c-4ef2-bf9d-eadd927c5b97', concepts.map)::TEXT                 as "Enc.Referral Slip given at Facility 3?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '7c053916-0be1-40aa-aae4-397838beef66', concepts.map)::TEXT                 as "Enc.Type of transport used from Facility 3",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'f6a950ca-5268-4ef4-8643-9b1f774f856e', concepts.map)::TEXT                  as "Enc.Treatment given at Facility 3",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '52cdaadb-99ec-4140-a66e-23c3375d2744', concepts.map)::TEXT                  as "Enc.Who attended at Facility 4?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '004e3e9c-1c19-45e3-bed1-f12ded3ce63e', concepts.map)::TEXT                 as "Enc.Type of facility referred at Facility 4",
       (programEncounter.observations ->> '7d85f8c8-2f75-46c3-b3f8-f46117cbc9fb')::DATE                    as "Enc.Date of referral from Facility 4",
       get_coded_string_value(
                  programEncounter.observations -> 'a14a9ca3-f4f0-4885-b4e5-b5acefcfab30', concepts.map)::TEXT                  as "Enc.Reason for referral from Facility 4",
       (programEncounter.observations ->> '04d0ef40-f3ea-4d55-a23c-cadf5ab2c1ae')::TEXT                    as "Enc.Other reason for referral from Facility 4",
       get_coded_string_value(
                  programEncounter.observations -> 'aca0991b-381e-476d-8df2-1d2bc61ebe69', concepts.map)::TEXT                 as "Enc.Referral Slip given at Facility 4?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '6535dbb5-ed11-45ba-bf04-dadacf1596a0', concepts.map)::TEXT                 as "Enc.Type of transport used from Facility 4",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'a69ef4cd-de59-4f90-98df-c014287fbe39', concepts.map)::TEXT                  as "Enc.Treatment given at Facility 4",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '5678560f-0632-44b1-9d6f-1b9c111dfe89', concepts.map)::TEXT                  as "Enc.Who attended at Facility 5?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'f6557b79-a79a-4728-8d7e-28f8875d1937', concepts.map)::TEXT                 as "Enc.Type of facility referred at Facility 5",
       (programEncounter.observations ->> '40afd0f6-2b1f-4abb-a1a8-2447b9075e47')::DATE                    as "Enc.Date of referral from Facility 5",
       get_coded_string_value(
                  programEncounter.observations -> '439381ac-430a-4341-adad-d1ebeb801e55', concepts.map)::TEXT                  as "Enc.Reason for referral from Facility 5",
       (programEncounter.observations ->> 'e2f483a9-9093-40d7-b493-014798709bd4')::TEXT                    as "Enc.Other reason for referral from Facility 5",
       get_coded_string_value(
                  programEncounter.observations -> '7b88f490-cfa1-4ab1-8c67-083b162e4b66', concepts.map)::TEXT                 as "Enc.Referral Slip given at Facility 5?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'a59c217b-5451-4f5d-a20a-844cc99e9426', concepts.map)::TEXT                 as "Enc.Type of transport used from Facility 5",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '98dc7010-63d6-4b46-a11e-07c34ddd7b45', concepts.map)::TEXT                  as "Enc.Treatment given at Facility 5",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '34179738-feb8-47e6-864e-9e758e93ba53', concepts.map)::TEXT                  as "Enc.Who attended at Facility 6?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'eefb864c-0fac-4a62-8a16-d4092302a5d4', concepts.map)::TEXT                 as "Enc.Type of facility referred at Facility 6",
       (programEncounter.observations ->> '56532853-6dcf-4494-be21-6e3d69ea057d')::DATE                    as "Enc.Date of referral from Facility 6",
       get_coded_string_value(
                  programEncounter.observations -> '5e373d3c-bf33-4a17-8819-d5e136c6133b', concepts.map)::TEXT                  as "Enc.Reason for referral from Facility 6",
       (programEncounter.observations ->> '2240fb6e-c156-430a-89fd-a9d10f027c17')::TEXT                    as "Enc.Other reason for referral from Facility 6",
       get_coded_string_value(
                  programEncounter.observations -> '610a6f50-7e8a-4bc3-9c9e-b2fb85846175', concepts.map)::TEXT                 as "Enc.Referral Slip given at Facility 6?",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'e760187b-f01f-4e30-aad1-e137e82ce909', concepts.map)::TEXT                 as "Enc.Type of transport used from Facility 6",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '3d603cd3-8353-4361-af8e-c1951a17f650', concepts.map)::TEXT                  as "Enc.Treatment given at Facility 6",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '100b445e-1a08-4d85-a2cb-7bafc0b0a9f9', concepts.map)::TEXT                 as "Enc.Is Abortion Cause",
       get_coded_string_value(
                  programEncounter.observations -> '460f62be-5bad-4aae-96ec-ec828ecfa1c6', concepts.map)::TEXT                 as "Enc.Ectopic Pregnancy",
       get_coded_string_value(
                  programEncounter.observations -> '708740ff-7823-4f3b-a4eb-9e9188961649', concepts.map)::TEXT                 as "Enc.Gestational Trophoblastic Disease",
       get_coded_string_value(
                  programEncounter.observations -> '25367c7e-d01b-4fa2-8358-f8c18e2687b6', concepts.map)::TEXT                 as "Enc.Antepartum Bleeding",
       get_coded_string_value(
                  programEncounter.observations -> '1f8ba737-518f-44ec-8e5b-a8007b09b7a9', concepts.map)::TEXT                 as "Enc.Placental Causes",
       get_coded_string_value(
                  programEncounter.observations -> 'b1eda256-213e-43bb-a06c-d6bfb60b16bf', concepts.map)::TEXT                 as "Enc.Late pregnancy Bleeding other than placental causes",
       (programEncounter.observations ->> '97aa7c03-1177-40e8-911d-afe5a9595d05')::TEXT                    as "Enc.Other cause of Antepartum Bleeding",
       get_coded_string_value(
                  programEncounter.observations -> '31804433-94c1-4d35-8e97-bde2a793f480', concepts.map)::TEXT                 as "Enc.Intrapartum Bleeding",
       get_coded_string_value(
                  programEncounter.observations -> 'f61fb650-e75f-4f47-8ede-1d01bba4c082', concepts.map)::TEXT                  as "Enc.Postpartum Bleeding",
       get_coded_string_value(
                  programEncounter.observations -> '9929586a-01a9-4f9a-9731-71a669f9312d', concepts.map)::TEXT                 as "Enc.Hypertensive disorder of Pregnancy",
       get_coded_string_value(
                  programEncounter.observations -> 'ea73bc0a-678b-46a6-9885-95a33a673c8d', concepts.map)::TEXT                 as "Enc.labor related Disorder",
       (programEncounter.observations ->> 'a1d50f93-2d22-464a-93c8-62384ec0c674')::TEXT                    as "Enc.Other labor related disorder",
       get_coded_string_value(
                  programEncounter.observations -> '1aae23a3-aa93-4065-a9d4-86b1f5e80c10', concepts.map)::TEXT                 as "Enc.Medical Disorder",
       (programEncounter.observations ->> '4b7f1dab-65c4-4f21-852b-861ee7a0ffae')::TEXT                    as "Enc.Other Medical Disorder",
       get_coded_string_value(
                  programEncounter.observations -> 'f088de32-c472-4468-88a4-3a250da5b473', concepts.map)::TEXT                 as "Enc.Diagnosis",
       get_coded_string_value(
                  programEncounter.observations -> '3f007de4-fd27-45df-9027-b865786c23bc', concepts.map)::TEXT                 as "Enc.Underlying cause of infection",
       (programEncounter.observations ->> '25b3a228-d1e4-49ae-aba4-4a7dfa49bbb5')::TEXT                    as "Enc.Other underlying cause of infection",
       get_coded_string_value(
                  programEncounter.observations -> '5d9c6cb9-d49f-4c5b-a8c8-ac37ba97b495', concepts.map)::TEXT                 as "Enc.Incidental/Accidental Disorder",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'b3e245ca-a965-464f-823a-cd75ead26911', concepts.map)::TEXT                 as "Enc.Abortion type",
       get_coded_string_value(
                  programEncounter.observations -> '59ebc42c-01cd-4d50-a055-6406d00faf2d', concepts.map)::TEXT                 as "Enc.Spontaneous abortion detail",
       get_coded_string_value(
                  programEncounter.observations -> 'dfa16927-16b3-4746-a39c-2d62214ceaae', concepts.map)::TEXT                 as "Enc.Induced abortion details",
       get_coded_string_value(
                  programEncounter.observations -> '44a60c43-b235-4e28-ba60-eeab1a2d1974', concepts.map)::TEXT                 as "Enc.Abortion procedure adopted",
       (programEncounter.observations ->> 'dea402d1-ec3e-4f5f-a4a6-cfd4af61b7e2')::TEXT                    as "Enc.Other procedure adopted for abortion",
       get_coded_string_value(
                  programEncounter.observations -> '97b5a664-97c2-421b-bc8e-7be3875e7807', concepts.map)::TEXT                 as "Enc.Post abortal period symptoms",
       get_coded_string_value(
                  programEncounter.observations -> '6b86a5a2-bf82-4855-a63d-16d8237ecc2b', concepts.map)::TEXT                 as "Enc.Termination done in more than 1 center",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '4497cd7f-da68-4bff-81ca-4eb3d0ced0ec', concepts.map)::TEXT                 as "Enc.ANC Received",
       get_coded_string_value(
                  programEncounter.observations -> '113a3c58-0211-44b7-8ac1-976f3580b6ec', concepts.map)::TEXT                  as "Enc.Type of facility",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'e315b178-a617-415e-a55a-93e64075cacc', concepts.map)::TEXT                  as "Enc.Service provided by",
       (programEncounter.observations ->> '2e808513-8949-41d8-ae19-ef1225284b81')::TEXT                    as "Enc.Details of Other specialists",
       get_coded_string_value(
                  programEncounter.observations -> '3b480c15-9a8d-4594-9b39-0f15138a3f78', concepts.map)::TEXT                 as "Enc.Told about disorder/ complication",
       get_coded_string_value(
                  programEncounter.observations -> 'c78bdae2-6ba0-4eda-909e-41d2f3aaf271', concepts.map)::TEXT                  as "Enc.Risk factor identified",
       (programEncounter.observations ->> 'b3164f0c-7629-41ec-8060-5a6a32e8aae2')::TEXT                    as "Enc.Other risk factor identified",
       get_coded_string_value(
                  programEncounter.observations -> 'bbb1a2b5-9535-46da-9e2b-67b47b5cc5e7', concepts.map)::TEXT                 as "Enc.Labor pain",
       get_coded_string_value(
                  programEncounter.observations -> '402742ac-14bf-4392-ba7c-3e5250a223fb', concepts.map)::TEXT                 as "Enc.Past facility",
       get_coded_string_value(
                  programEncounter.observations -> '4888f0d8-7e78-4441-9b2e-3eee56e77f89', concepts.map)::TEXT                 as "Enc.Current facility",
       get_coded_string_value(
                  programEncounter.observations -> 'e26cd7f7-0117-4b9c-bfa0-6055b68e6430', concepts.map)::TEXT                  as "Enc.Complication during labor",
       (programEncounter.observations ->> '957cfe64-0c4e-4a33-af6d-525bd352b03e')::TEXT                    as "Enc.Other complication during labor",
       get_coded_string_value(
                  programEncounter.observations -> 'eff2209c-5e76-4da6-8a8a-8c9a1c4795b9', concepts.map)::TEXT                 as "Enc.Undelivered mode",
       get_coded_string_value(
                  programEncounter.observations -> '34a73afe-b6d0-4e70-af4a-6c9710de95dc', concepts.map)::TEXT                 as "Enc.Vaginal Delivery",
       get_coded_string_value(
                  programEncounter.observations -> '28f5d885-23d0-45ac-833f-0d6f20e3f56d', concepts.map)::TEXT                 as "Enc.Caesarean section type",
       get_coded_string_value(
                  programEncounter.observations -> 'b6861170-19a1-4398-9c20-9561883f1e3d', concepts.map)::TEXT                 as "Enc.Laparotomy type",
       get_coded_string_value(
                  programEncounter.observations -> '8af338f7-0014-454e-afa2-479e3b42c4f6', concepts.map)::TEXT                 as "Enc.Indication type",
       get_coded_string_value(
                  programEncounter.observations -> '13edc693-1f6b-4863-88bb-56a2d3dbf3b6', concepts.map)::TEXT                 as "Enc.Anaesthesia",
       get_coded_string_value(
                  programEncounter.observations -> 'c412ce45-df14-46b6-941b-0c35e147d767', concepts.map)::TEXT                 as "Enc.Stage of Labor",
       get_coded_string_value(
                  programEncounter.observations -> '95027850-dabc-404e-8ad5-82abe85ec39a', concepts.map)::TEXT                 as "Enc.Post birth details",
       get_coded_string_value(
                  programEncounter.observations -> '3bf2f6dc-49c6-4395-a918-43af5f458d6b', concepts.map)::TEXT                 as "Enc.Gave birth",
       get_coded_string_value(
                  programEncounter.observations -> 'd5fc607b-aced-446d-b89d-59038b09bbbe', concepts.map)::TEXT                 as "Enc.Neonatal Outcome",
       get_coded_string_value(
                  programEncounter.observations -> '206af019-6ea1-4b0e-ab51-3b6218e61eba', concepts.map)::TEXT                 as "Enc.Probable cause of death",
       (programEncounter.observations ->> 'c6ab74e9-ea91-4614-8983-3f3136d4b10a')::TEXT                    as "Enc.Other Cause of death",
       get_coded_string_value(
                  programEncounter.observations -> 'aa3ba2ab-7731-4a27-8a8a-d385f0c6b1f8', concepts.map)::TEXT                 as "Enc.Postnatal Period",
       get_coded_string_value(
                  programEncounter.observations -> '0705498d-175d-4639-bd53-18eeac59f877', concepts.map)::TEXT                 as "Enc.Probable cause of death in case of eventful death",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'b40e4fec-eeb4-499d-947c-133b5811e34b', concepts.map)::TEXT                  as "Enc.Early pregnancy interventions",
       get_coded_string_value(
                  programEncounter.observations -> '0827a2e8-a2b9-45fb-9692-c81836c5b122', concepts.map)::TEXT                  as "Enc.Antenatal Interventions",
       get_coded_string_value(
                  programEncounter.observations -> '27505089-3f5e-444f-878b-87b22d69f070', concepts.map)::TEXT                  as "Enc.Intrapartum Intervention",
       get_coded_string_value(
                  programEncounter.observations -> '0d3b9940-1410-4b98-ba1e-ca934fc1b05d', concepts.map)::TEXT                  as "Enc.Postpartum Intervention",
       get_coded_string_value(
                  programEncounter.observations -> '2cbb7e66-6b9c-41ca-8636-34e50255dddc', concepts.map)::TEXT                  as "Enc.Anaesthesia Intervention",
       get_coded_string_value(
                  programEncounter.observations -> '2860dd68-3c69-4d0d-a5bc-47c2826ac6fb', concepts.map)::TEXT                 as "Enc.Blood transfusion given",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '741f9df1-8dcb-44b8-a9b6-70b89fed87f4', concepts.map)::TEXT                 as "Enc.Transfusion reaction occurred",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '27a14e4f-b074-4d5b-8358-2ffdfa6c25a2', concepts.map)::TEXT                 as "Enc.Cause of maternal death",
       get_coded_string_value(
                  programEncounter.observations -> '388b96fa-4756-455a-baa9-38e00f090f3f', concepts.map)::TEXT                  as "Enc.Pregnancies with abortive outcome",
       get_coded_string_value(
                  programEncounter.observations -> '41b9a15f-d576-4457-8594-b2576a7cf3f4', concepts.map)::TEXT                  as "Enc.Hypertensive disorders in pregnancy, birth and puerperium",
       get_coded_string_value(
                  programEncounter.observations -> '060e631e-6b1e-4d53-8f59-1227fee486db', concepts.map)::TEXT                  as "Enc.Obstetric Haemmorhage",
       get_coded_string_value(
                  programEncounter.observations -> '9e7056f9-ba29-45cd-b019-a1bc2e079f56', concepts.map)::TEXT                  as "Enc.Pregnancy related infection",
       get_coded_string_value(
                  programEncounter.observations -> '93c029e4-005f-46b6-93fb-9041d8d1252b', concepts.map)::TEXT                  as "Enc.Other Obstetric complications",
       get_coded_string_value(
                  programEncounter.observations -> '470ad5fc-7931-47bc-afcc-0c77b63edf1a', concepts.map)::TEXT                  as "Enc.Other direct cause",
       get_coded_string_value(
                  programEncounter.observations -> 'd6990222-a6fe-4f42-a0a1-1279886672bb', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Anaemia",
       get_coded_string_value(
                  programEncounter.observations -> '1860f864-b1c2-444b-a89a-394bc0674b31', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Cardiac disorders",
       get_coded_string_value(
                  programEncounter.observations -> 'e53298d5-d291-4b4a-9822-a8a3cdc6469c', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Liver Disorders",
       get_coded_string_value(
                  programEncounter.observations -> 'be0d7917-421b-4254-a895-6830af9b16b6', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Respiratory Disorders",
       get_coded_string_value(
                  programEncounter.observations -> 'db0ed88c-f838-485e-9de2-b2626982ef4b', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Renal disorders",
       get_coded_string_value(
                  programEncounter.observations -> 'bc93dda2-15c4-4321-ac36-6bfca096f5ad', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Endocrinal Disorders",
       get_coded_string_value(
                  programEncounter.observations -> '949a41b4-98f2-4048-b50e-bb27d79ba9e0', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Neurological Disorders",
       get_coded_string_value(
                  programEncounter.observations -> '39367397-a350-4eac-a5dd-a27c5d39d700', concepts.map)::TEXT                  as "Enc.Non-obstetric complications- Infections/ Infestations",
       get_coded_string_value(
                  programEncounter.observations -> 'da364946-d11b-4ce2-85c6-1d61daf62dd0', concepts.map)::TEXT                 as "Enc.Delay in woman seeking help",
       get_coded_string_value(
                  programEncounter.observations -> '7c942ee9-dd3f-4476-8d58-b2bb9c9e4323', concepts.map)::TEXT                 as "Enc.Refusal of treatment or admission",
       get_coded_string_value(
                  programEncounter.observations -> '5358eb08-5d76-481a-89ce-f2eb24ad302f', concepts.map)::TEXT                 as "Enc.Refusal of admission in previous facility",
       get_coded_string_value(
                  programEncounter.observations -> 'fcdeadae-e1f8-4a0d-89f5-2e1b0104073e', concepts.map)::TEXT                 as "Enc.Logistical Problems",
       get_coded_string_value(
                  programEncounter.observations -> '57afa4f8-a533-4bb0-b4a7-62094ec53868', concepts.map)::TEXT                 as "Enc.lack of transport from home to health care facility",
       get_coded_string_value(
                  programEncounter.observations -> '33e76c6c-41a8-4d68-8d87-7fb0c0f1d410', concepts.map)::TEXT                 as "Enc.Lack of transport between health care facilities",
       get_coded_string_value(
                  programEncounter.observations -> 'e7cbc7b0-7b96-448a-8c40-eb09f2220878', concepts.map)::TEXT                 as "Enc.lack of assured referral system",
       get_coded_string_value(
                  programEncounter.observations -> '45adbbbb-a6c7-4678-8139-a4e41e8f5aaa', concepts.map)::TEXT                 as "Enc.Lack of facilities, equipment or consumable",
       get_coded_string_value(
                  programEncounter.observations -> 'cb2f1f5e-3085-4fe2-ab9c-8da142339f0a', concepts.map)::TEXT                 as "Enc.Lack of blood/ blood product",
       get_coded_string_value(
                  programEncounter.observations -> 'd7fb30ff-4c70-4fc2-b938-10ca8d7121fd', concepts.map)::TEXT                 as "Enc.Lack of OT availability",
       get_coded_string_value(
                  programEncounter.observations -> '662f1569-41b1-4eb3-8983-f962918bc59c', concepts.map)::TEXT                 as "Enc.Lack of human resources",
       get_coded_string_value(
                  programEncounter.observations -> '99e5b54b-9ebf-4832-b7ce-85134cadf9b1', concepts.map)::TEXT                 as "Enc.Lack of Anesthetist",
       get_coded_string_value(
                  programEncounter.observations -> '57d52e87-695c-4a4f-b262-5d495a6c8ca4', concepts.map)::TEXT                 as "Enc.Lack of Obstetricians",
       get_coded_string_value(
                  programEncounter.observations -> 'c0e38dc4-d72e-498c-af8b-6b2ad00a7841', concepts.map)::TEXT                 as "Enc.Lack of expertise, training or education",
       get_coded_string_value(
                  programEncounter.observations -> 'e93127f1-7b72-4acc-99a4-00ad59b750ed', concepts.map)::TEXT                 as "Enc.Autopsy performed",
...
SELECT individual.id                                                                                          "Ind.Id",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '04880a88-b87e-4bd5-a75d-ce230b847506', concepts.map)::TEXT                 as "Enc.Probable cause of death details",
       (programEncounter.observations ->> 'e3a7aab6-e92a-45b6-b04f-81c8c9af29f3')::TEXT                    as "Enc.Other probable cause of death",
       get_coded_string_value(
                  programEncounter.observations -> '55b83b4e-48a0-432c-be25-d164e0067561', concepts.map)::TEXT                 as "Enc.Participate in this interview",
       (programEncounter.observations ->> '2967f6b2-7f22-428d-b753-deb91791cd5f')::TEXT                    as "Enc.Respondent Name",
       ...
       (programEncounter.observations ->> 'edd950ba-148d-4e1d-b086-6de471a6b965')::TEXT                    as "Enc.Age of the deceased woman at the time of death",
       get_coded_string_value(
                  programEncounter.observations -> '1ffb6eeb-84ab-4323-b86b-ea97fbc847d1', concepts.map)::TEXT                 as "Enc.Period of Death",
       get_coded_string_value(
                  programEncounter.observations -> '3f6c371a-4638-4823-be14-98c22f208902', concepts.map)::TEXT                 as "Enc.Place of death",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'f44552ea-41f7-4056-b3ca-6867d3893ec2', concepts.map)::TEXT                 as "Enc.Did the doctor or nurse at the health facility tell you the cause of death.",
       (programEncounter.observations ->> '105764fd-9786-4254-b3ae-a00f711ec952')::TEXT                    as "Enc.Cause of death",
       get_coded_string_value(
                  programEncounter.observations -> 'c7381c2e-1f1d-4175-b8d9-9ebc54cae55b', concepts.map)::TEXT                 as "Enc.Deceased woman married",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '61ab6413-5c6a-4512-ab6e-7d5cd1439569', concepts.map)::TEXT                 as "Enc.Caste Category",
       get_coded_string_value(
                  programEncounter.observations -> '7a30ab52-f140-49be-8386-085d36379cfa', concepts.map)::TEXT                 as "Enc.BPL Status",
       get_coded_string_value(
                  programEncounter.observations -> '39595a16-a9c6-49a5-a42b-3f462607058c', concepts.map)::TEXT                 as "Enc.Education",
       ...
       (programEncounter.observations ->> '38b9986b-76e8-4015-ae51-48152b1cd42c')::TEXT                    as "Enc.Number of abortions",
       get_coded_string_value(
                  programEncounter.observations -> '59ff5327-2911-4fb0-a895-3b3714550147', concepts.map)::TEXT                 as "Enc.Infant Survival",
       get_coded_string_value(
                  programEncounter.observations -> '913df14a-525d-4fd0-b69f-4a5a9acab7b0', concepts.map)::TEXT                 as "Enc.Antenatal care received",
       (programEncounter.observations ->> 'bdd87c87-f073-40c0-952a-38f9cd160235')::TEXT                    as "Enc.Number of Antenatal care received",
       get_coded_string_value(
                  programEncounter.observations -> 'bf699779-4fd4-48d0-8450-e843ecded6eb', concepts.map)::TEXT                  as "Enc.Place of antenatal checkup",
       (programEncounter.observations ->> 'af349d7b-22fd-43d7-925d-b7c4af0b0e49')::TEXT                    as "Enc.Other place of antenatal checkup",
       get_coded_string_value(
                  programEncounter.observations -> '15423d2c-4d95-4b4e-a574-47e4049c8ceb', concepts.map)::TEXT                  as "Enc.Services during ANC",
       get_coded_string_value(
                  programEncounter.observations -> '11e40f0e-4b64-4b49-a3c6-624669c07165', concepts.map)::TEXT                 as "Enc.Problem during antenatal period",
       get_coded_string_value(
                  programEncounter.observations -> '1e542756-fa2e-4cef-925c-7f36bb54156e', concepts.map)::TEXT                 as "Enc.Symptoms for problems during ANC",
       (programEncounter.observations ->> '899fd3df-dcbd-4024-8a4e-86f2df2f60bc')::TEXT                    as "Enc.Other Symptoms",
       get_coded_string_value(
                  programEncounter.observations -> '8a46cfec-f6c4-4802-ac8d-3d230c8dab11', concepts.map)::TEXT                 as "Enc.Care for these symptoms",
       get_coded_string_value(
                  programEncounter.observations -> 'f061a8b1-213b-47db-954a-e43b80a4cb56', concepts.map)::TEXT                  as "Enc.Where seeked care",
       (programEncounter.observations ->> 'a6bf54e1-4591-4f5f-8600-a2c6fab928f3')::TEXT                    as "Enc.Other seeked care",
       get_coded_string_value(
                  programEncounter.observations -> '62cc39a8-be58-473e-9fde-36824ab73127', concepts.map)::TEXT                  as "Enc.Reason for not seeking care 3",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '86039e4d-efd8-4920-9e73-869fca7bc0a9', concepts.map)::TEXT                  as "Enc.Symptoms at time of death",
       (programEncounter.observations ->> '2266a771-71bf-4f8f-a0ba-267bfd630982')::TEXT                    as "Enc.Other symptoms at time of death",
       get_coded_string_value(
                  programEncounter.observations -> '514144ac-4782-481d-b32c-19dcd9f28ff4', concepts.map)::TEXT                 as "Enc.Referred at that time",
       get_coded_string_value(
                  programEncounter.observations -> 'ee47b9b0-eb32-4bab-80cc-efd525f01f98', concepts.map)::TEXT                 as "Enc.Did she seek care",
       get_coded_string_value(
                  programEncounter.observations -> '2b3da568-9523-42e4-a9ab-4ef581096723', concepts.map)::TEXT                 as "Enc.Where seeked care for these complications",
       ...
       (programEncounter.observations ->> '2adf6c28-d52b-4a4a-9b66-b59406297a9d')::TIMESTAMP                    as "Enc.Time of arrival of transport at Facility 1",
       get_coded_string_value(
                  programEncounter.observations -> 'bb85a4a6-d35b-4878-80fd-2aca12af2857', concepts.map)::TEXT                 as "Enc.Referral transport used",
       (programEncounter.observations ->> '02afc5fa-0af3-4e20-a88e-d5adf0b8b833')::TEXT                    as "Enc.Other type of transport used from Facility 1",
       (programEncounter.observations ->> 'd3fbfce1-ff22-42ce-99bc-4df3c3361046')::TEXT                    as "Enc.Time taken to reach Facility 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'db1a4228-8029-4039-aa8c-334da1fba10e', concepts.map)::TEXT                  as "Enc.Attened at facility 1 by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '61dfc28e-54e6-4a66-9449-c6b1e92e710e', concepts.map)::TEXT                 as "Enc.Referral slip given from Facility 1",
       get_coded_string_value(
                  programEncounter.observations -> 'e751fcb0-d8c3-47fc-8d39-d61feff047d2', concepts.map)::TEXT                 as "Enc.Treatment given at Facility 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'a388eef9-2abc-41f5-a195-8936d396a05b', concepts.map)::TEXT                 as "Enc.Referral transport used from facility 2",
       (programEncounter.observations ->> '25b33aef-788c-4dcc-86ba-ee2727adbf51')::TEXT                    as "Enc.Other type of transport used from Facility 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '0f498e7c-92e6-4407-8c76-526127e4037a', concepts.map)::TEXT                  as "Enc.Attended at facility 2 by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'dcd04ea9-c92b-4356-94dd-67408e17c933', concepts.map)::TEXT                 as "Enc.Referral slip given from Facility 2",
       get_coded_string_value(
                  programEncounter.observations -> '70f354df-5846-4e7d-aec2-661bd2aba924', concepts.map)::TEXT                 as "Enc.Treatment given at Facility 2",
       ...
       (programEncounter.observations ->> '4fa759a6-6f00-4926-9362-9417d80f40c0')::TIMESTAMP                    as "Enc.Time of arrival of transport at Facility 3",
       get_coded_string_value(
                  programEncounter.observations -> '328d7efd-39a5-4aa6-9e31-26bebced8d1b', concepts.map)::TEXT                 as "Enc.Referral transport used from facility 3",
       (programEncounter.observations ->> 'a82c140d-bf5c-426b-9a18-296b31504f43')::TEXT                    as "Enc.Other type of transport used from Facility 3",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'e9c09426-00ba-4ffb-90a1-9b3ead39a337', concepts.map)::TEXT                  as "Enc.Attended at facility 3 by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'c9a0d818-4fda-4c28-bb33-4551740eedf2', concepts.map)::TEXT                 as "Enc.Referral slip given from Facility 3",
       get_coded_string_value(
                  programEncounter.observations -> 'f6a950ca-5268-4ef4-8643-9b1f774f856e', concepts.map)::TEXT                 as "Enc.Treatment given at Facility 3",
       ...
       (programEncounter.observations ->> '9fd80d7a-7eae-4be0-a050-5ceed157e5e8')::TIMESTAMP                    as "Enc.Time of arrival of transport at Facility 4",
       get_coded_string_value(
                  programEncounter.observations -> '9819aa51-f52f-413c-b8fd-4b407ffa8500', concepts.map)::TEXT                 as "Enc.Referral transport used from facility 4",
       (programEncounter.observations ->> '60a55b00-ddfa-4ac3-87de-5d45e5aed5c7')::TEXT                    as "Enc.Other type of transport used from Facility 4",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'ab3850eb-ecf3-40f1-9595-f8d7a5b73df3', concepts.map)::TEXT                  as "Enc.Attended at facility 4 by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'c47dc768-2630-4942-91ba-d0d7b18bfe62', concepts.map)::TEXT                 as "Enc.Referral slip given from Facility 4",
       get_coded_string_value(
                  programEncounter.observations -> 'a69ef4cd-de59-4f90-98df-c014287fbe39', concepts.map)::TEXT                 as "Enc.Treatment given at Facility 4",
       ...
       (programEncounter.observations ->> 'ca1dee29-7910-4325-8b3e-fe682fd72b31')::TIMESTAMP                    as "Enc.Time of arrival of transport at Facility 5",
       get_coded_string_value(
                  programEncounter.observations -> 'fa119bd1-3466-4c81-94bd-73c0607dfe99', concepts.map)::TEXT                 as "Enc.Referral transport used from facility 5",
       (programEncounter.observations ->> '6cb7786a-d76f-4056-968f-5a951188d62c')::TEXT                    as "Enc.Other type of transport used from Facility 5",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '2eaa8d56-57bd-457b-8a01-6c317bf720aa', concepts.map)::TEXT                  as "Enc.Attended at facility 5 by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '8431dffb-ce81-48b8-84e6-66b25fb8e1ea', concepts.map)::TEXT                 as "Enc.Referral slip given from Facility 5",
       get_coded_string_value(
                  programEncounter.observations -> '98dc7010-63d6-4b46-a11e-07c34ddd7b45', concepts.map)::TEXT                 as "Enc.Treatment given at Facility 5",
       ...
       (programEncounter.observations ->> '233fb4fb-a334-4305-ab77-164ab31912c5')::TIMESTAMP                    as "Enc.Time of arrival of transport at Facility 6",
       get_coded_string_value(
                  programEncounter.observations -> 'e7026a6c-68a1-4846-8a35-1a42a3606532', concepts.map)::TEXT                 as "Enc.Referral transport used from facility 6",
       (programEncounter.observations ->> 'ec9ebede-368b-491b-842a-1b01a59c7b33')::TEXT                    as "Enc.Other type of transport used from Facility 6",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '6adc8455-4b3b-4ee3-ac34-ff3f4ddf1dea', concepts.map)::TEXT                  as "Enc.Attended at facility 6 by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '6a704866-52fa-46a4-a540-abee351c353d', concepts.map)::TEXT                 as "Enc.Referral slip given from Facility 6",
       get_coded_string_value(
                  programEncounter.observations -> '3d603cd3-8353-4361-af8e-c1951a17f650', concepts.map)::TEXT                 as "Enc.Treatment given at Facility 6",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'b559e6c1-4f0a-41cc-8e3d-79cc81caf846', concepts.map)::TEXT                  as "Enc.Reasons for not seeking care",
       (programEncounter.observations ->> 'b7b8a157-12b6-480e-adc3-7db72b7cec18')::TEXT                    as "Enc.Other reason for not seeking care 2",
       get_coded_string_value(
                  programEncounter.observations -> 'ef32af44-9595-4f23-a441-f3b7e2b91665', concepts.map)::TEXT                 as "Enc.Did deceased woman died while having abortion",
       get_coded_string_value(
                  programEncounter.observations -> '3c387716-7fe2-40d6-86a6-41628ed50edb', concepts.map)::TEXT                 as "Enc.Type of abortion",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '71980fe4-af70-4e4b-a53a-735b738238e6', concepts.map)::TEXT                 as "Enc.Where was the abortion completed",
       (programEncounter.observations ->> 'd742e6b7-8ed7-4d83-8513-2ec303faf2f5')::TEXT                    as "Enc.Other, where was abortion completed",
       get_coded_string_value(
                  programEncounter.observations -> '5583472c-5559-407b-b2eb-8e32d709b2f1', concepts.map)::TEXT                 as "Enc.Abortion inducing method",
       get_coded_string_value(
                  programEncounter.observations -> '2fc661cb-29fb-4bfe-9b6c-77375173405d', concepts.map)::TEXT                 as "Enc.Induced abortion performed at",
       (programEncounter.observations ->> '8fe6bbc8-6cae-41c5-985a-979a4944da8b')::TEXT                    as "Enc.Other, where she had induced abortion",
       get_coded_string_value(
                  programEncounter.observations -> 'a0ac3d78-77ae-45a8-af66-8f6d1144c8a2', concepts.map)::TEXT                  as "Enc.Induced abortion performed by",
       (programEncounter.observations ->> '80bc390f-dc9a-465e-96c8-40cae85e6a9c')::TEXT                    as "Enc.Other, who performed the abortion",
       get_coded_string_value(
                  programEncounter.observations -> 'e31162a3-ca80-4ce8-adfc-97b201be3e21', concepts.map)::TEXT                 as "Enc.Reason for inducing the abortion",
       (programEncounter.observations ->> '1f5b781c-1360-4ab8-9dd1-4fc9bdecad71')::TEXT                    as "Enc.Description of inducing abortion",
       get_coded_string_value(
                  programEncounter.observations -> 'c7c04aac-f63c-4c0e-8b11-7e379cb8e31f', concepts.map)::TEXT                  as "Enc.Complication/symptoms after the abortion",
       get_coded_string_value(
                  programEncounter.observations -> 'd0073b51-c020-489b-bfba-cbb3834cb1e4', concepts.map)::TEXT                 as "Enc.Seek care after developing complication 1",
       get_coded_string_value(
                  programEncounter.observations -> '02f97f10-5043-4db1-952c-803762532df0', concepts.map)::TEXT                 as "Enc.Seek care after developing complication 2",
       (programEncounter.observations ->> '6ff1cc86-efdb-4f17-9666-5841321087b0')::TEXT                    as "Enc.VIII. 11. If Other, specify",
       get_coded_string_value(
                  programEncounter.observations -> '12bbcc67-21e0-4e4b-8fa3-6c1c1f1ef3d9', concepts.map)::TEXT                  as "Enc.Reason for not seeking the care",
       (programEncounter.observations ->> '668dd606-f285-42c9-92af-b6a6edfdb5e1')::TEXT                    as "Enc.Other reason for not seeking care 3",
       get_coded_string_value(
                  programEncounter.observations -> '704bd399-471e-47f7-a557-15a8822e7de0', concepts.map)::TEXT                 as "Enc.Place of delivery.",
       (programEncounter.observations ->> 'b600db53-5338-47ff-b4af-cd9118f7e91b')::TEXT                    as "Enc.Other, place of delivery",
       get_coded_string_value(
                  programEncounter.observations -> 'e7ae50e1-4c1c-43bd-8584-54b0d24d109a', concepts.map)::TEXT                  as "Enc.Reason for home delivery",
       ...
       (programEncounter.observations ->> 'dcb4741d-d65c-404e-8aec-8b805cde875a')::TIMESTAMP                    as "Enc.Date and time of Delivery",
       get_coded_string_value(
                  programEncounter.observations -> '3868f0f7-51b7-4714-ab84-6ecb321ae885', concepts.map)::TEXT                  as "Enc.Delivery conducted by",
       (programEncounter.observations ->> '462fff03-0a0c-4552-bf78-7a212834c6e5')::TEXT                    as "Enc.other, delivery conducte by",
       get_coded_string_value(
                  programEncounter.observations -> 'aac560fc-303d-464d-9922-f0e4ea18d79d', concepts.map)::TEXT                 as "Enc.Type of delivery.",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '301165eb-9c76-45c0-89a8-a21eac81cfbf', concepts.map)::TEXT                  as "Enc.Complication during labor.",
       (programEncounter.observations ->> 'a45ea9cd-2be0-4d0a-b68d-5150dedd01bc')::TEXT                    as "Enc.Other complication during labor / delivery",
       get_coded_string_value(
                  programEncounter.observations -> 'c2f51fe9-1610-4535-a679-bb77cebe9ce9', concepts.map)::TEXT                  as "Enc.Treatmet provided at health facility",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'aad907d4-381c-4b04-82b6-86866f463eb4', concepts.map)::TEXT                 as "Enc.Information about the complication from hospital",
       (programEncounter.observations ->> '7a3d684c-a57e-4ceb-94a2-df45a5afaa37')::TEXT                    as "Enc.Description of information given",
       get_coded_string_value(
                  programEncounter.observations -> '4d83afcc-4eec-4bc3-81fe-2ea36f45ad3c', concepts.map)::TEXT                 as "Enc.Delay in initiating treatment 1",
       (programEncounter.observations ->> 'fe283485-a971-442f-a4e9-e2b21c32d505')::TEXT                    as "Enc.description of delay in treatment 1",
       get_coded_string_value(
                  programEncounter.observations -> 'df9125c1-af56-41ac-a3d9-a1025bac081b', concepts.map)::TEXT                 as "Enc.Care seeked in home delivery",
       get_coded_string_value(
                  programEncounter.observations -> '48b4a563-bf3c-4870-8415-c512f7e4c25f', concepts.map)::TEXT                  as "Enc.Reason for not seeking care in home delivery",
       (programEncounter.observations ->> 'd670c4f6-27bb-4c97-985e-c903b0dc1acc')::TEXT                    as "Enc.Other, reason for not seeking care",
       get_coded_string_value(
                  programEncounter.observations -> 'b169ef37-1f46-41e5-a0db-fa9e4eeb405b', concepts.map)::TEXT                 as "Enc.Where seek care",
       (programEncounter.observations ->> 'e34fa97d-1e9f-446f-a558-9cb1e95a9f9d')::TEXT                    as "Enc.Other, care seeked",
       get_coded_string_value(
                  programEncounter.observations -> '0a9358d2-84e8-4056-90c7-6ab36bd01ff6', concepts.map)::TEXT                 as "Enc.Information given about nature of complication",
       (programEncounter.observations ->> 'ced27e49-e658-4af8-a041-d374f61c4ea8')::TEXT                    as "Enc.Description of nature of complication",
       get_coded_string_value(
                  programEncounter.observations -> '8148431d-0006-4ce3-975e-35e0e6fe247b', concepts.map)::TEXT                 as "Enc.Delay in initiating treatment 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '73a40297-bf71-4def-a90f-36dad552422b', concepts.map)::TEXT                 as "Enc.Deceased woman referred from place of delivery",
       get_coded_string_value(
                  programEncounter.observations -> '9905cd49-e313-40e9-a367-74d34d82aba4', concepts.map)::TEXT                 as "Enc.deceased woman referred in case of home delivery",
       get_coded_string_value(
                  programEncounter.observations -> '82cc079f-6a8b-4368-9b1d-767483b3e232', concepts.map)::TEXT                 as "Enc.Woman attend referral centre",
       get_coded_string_value(
                  programEncounter.observations -> '71026db3-f2ff-4678-b554-5418c3ed23e9', concepts.map)::TEXT                  as "Enc.Reason for not seeking care 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'f9d8f7aa-c229-4af8-832a-24a6cdb62ae6', concepts.map)::TEXT                 as "Enc.Information given to relative about nature of complication",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'f48594bb-708a-4121-ab37-f885762a6a79', concepts.map)::TEXT                 as "Enc.Delay in initiating treatment 3",
       (programEncounter.observations ->> '63096bd8-bd43-45d9-84ad-2d68e8d3c29f')::TEXT                    as "Enc.description of delay in treatment 3",
       get_coded_string_value(
                  programEncounter.observations -> 'a8d00f9f-056a-4de5-90d8-224ec828ae71', concepts.map)::TEXT                 as "Enc.Any problem following delivery",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '915a72da-8e27-4aff-9283-a4459281522d', concepts.map)::TEXT                  as "Enc.Problem during postnatal period",
       (programEncounter.observations ->> 'a9e315dc-b178-45e5-9865-e042fb315bbf')::TEXT                    as "Enc.Describe Other, postnatal period problem",
       get_coded_string_value(
                  programEncounter.observations -> '4e65a938-503e-40ca-a121-41e855a09e63', concepts.map)::TEXT                 as "Enc.Did she seek treatment",
       get_coded_string_value(
                  programEncounter.observations -> 'a13c7c06-bc67-403e-92fa-740c3ea1cdad', concepts.map)::TEXT                 as "Enc.Where seeked treatment",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'bc39c166-c853-4170-8fc4-b5e876018f36', concepts.map)::TEXT                  as "Enc.Treatment in hospital",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '0c9ec484-a94e-4035-8460-d73c3d730557', concepts.map)::TEXT                 as "Enc.Was she referred",
       get_coded_string_value(
                  programEncounter.observations -> 'c968f906-79d2-4ac2-882d-7091302df767', concepts.map)::TEXT                 as "Enc.Referral attended",
       get_coded_string_value(
                  programEncounter.observations -> '4ccafbcf-0320-485d-8aee-4e66144ba6ef', concepts.map)::TEXT                 as "Enc.Reason for not seeking care 2",
       (programEncounter.observations ->> '325a9bbd-c400-41b8-a1bc-17a3b87edf85')::TEXT                    as "Enc.Other reason for not seeking care 4",
       get_coded_string_value(
                  programEncounter.observations -> 'c5726d7b-f470-4159-ae73-5578fce7f6d2', concepts.map)::TEXT                 as "Enc.Any postnatal checkups received",
       (programEncounter.observations ->> '4993b64f-e285-4b73-8d59-a181b579e6d6')::TEXT                    as "Enc.11. No of post natal checkups received",
       get_coded_string_value(
                  programEncounter.observations -> '13fee8d6-5c00-4256-a4e1-589febb538a5', concepts.map)::TEXT                  as "Enc.Postnatal checkup done by",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '93b1b241-e145-4e4f-a897-2dddc81d1b12', concepts.map)::TEXT                 as "Enc.X. Referral transport used",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'a86048c3-c55c-4478-9832-87e3544140a0', concepts.map)::TEXT                  as "Enc.X. Attened at facility 1 by",
       (programEncounter.observations ->> 'c91d02a8-2261-4a47-9afb-bdf4c80139f1')::TEXT                    as "Enc.X. Reason for referral from facility 1",
       get_coded_string_value(
                  programEncounter.observations -> '96dd6138-3c0d-40bd-aa59-807b62dd87a2', concepts.map)::TEXT                 as "Enc.X. Referral slip given from Facility 1",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'ed54c6c0-f08d-4a06-8835-9eff0b5f9824', concepts.map)::TEXT                 as "Enc.X. Referral transport used from facility 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '2d632d7d-4480-4bbe-b991-ccbfe8e29ce8', concepts.map)::TEXT                  as "Enc.X. Attended at facility by",
       (programEncounter.observations ->> '39e429b6-937f-41a8-8518-e594f66f481c')::TEXT                    as "Enc.X. Reason for referral from facility 2",
       get_coded_string_value(
                  programEncounter.observations -> '9f31e2f0-b193-4cad-93fe-c3f071e74bed', concepts.map)::TEXT                 as "Enc.X. Referral slip given from Facility 2",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '8bbe333f-acd5-4d95-96f9-d7e6ec00b0f3', concepts.map)::TEXT                 as "Enc.X. Referral transport used from facility 3",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'adfa5264-f51a-4986-a2c0-649cc523ae91', concepts.map)::TEXT                  as "Enc.X. Attended at facility 3 by",
       (programEncounter.observations ->> '005c1675-6d79-42d8-9039-622325097258')::TEXT                    as "Enc.X. Reason for referral from facility 3",
       get_coded_string_value(
                  programEncounter.observations -> 'c6080205-38d2-400b-8921-2177a82a9d7f', concepts.map)::TEXT                 as "Enc.X. Referral slip given from Facility 3",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '591c512a-fc78-49b1-a5c1-3e350f6a8600', concepts.map)::TEXT                 as "Enc.X. Referral transport used from facility 4",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '20b88cad-a02b-4ca6-b5e6-1ecb220002fb', concepts.map)::TEXT                  as "Enc.X. Attended at facility 4 by",
       (programEncounter.observations ->> '83d2eb2a-53ee-4f77-bd95-3c95e5d36664')::TEXT                    as "Enc.X. Reason for referral from facility 4",
       get_coded_string_value(
                  programEncounter.observations -> '99120eed-d90f-4d80-afcb-22f5786db428', concepts.map)::TEXT                 as "Enc.X. Referral slip given from Facility 4",
       ...
       get_coded_string_value(
                  programEncounter.observations -> 'e0f20cf4-6a59-4041-9edb-9bcf44a21e17', concepts.map)::TEXT                 as "Enc.X. Referral transport used from facility 5",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '87b4f4f0-7a38-4f36-8a32-83d57a1fcd5e', concepts.map)::TEXT                  as "Enc.X. Attended at facility 5 by",
       (programEncounter.observations ->> 'fdb6748d-6529-4024-87a4-5dc228d426f3')::TEXT                    as "Enc.X. Reason for referral from facility 5",
       get_coded_string_value(
                  programEncounter.observations -> '05302dc6-2417-4c22-a8d3-2db9cfe335a2', concepts.map)::TEXT                 as "Enc.X. Referral slip given from Facility 5",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '44992cff-46ff-4dcf-9250-a87c97d19eeb', concepts.map)::TEXT                 as "Enc.X. Referral transport used from facility 6",
       ...
       get_coded_string_value(
                  programEncounter.observations -> '07d19d6c-d654-4363-a618-df47aa67be3d', concepts.map)::TEXT                  as "Enc.X. Attended at facility 6 by",
       (programEncounter.observations ->> 'f9f5df1f-aeb7-45c7-baf3-723c28f02669')::TEXT                    as "Enc.X. Reason for referral from facility 6",
       get_coded_string_value(
                  programEncounter.observations -> '58c40e70-cc47-4405-a7e1-0b174bfe7a06', concepts.map)::TEXT                 as "Enc.X. Referral slip given from Facility 6",
...
SELECT individual.id                                                                          "Ind.Id",
       ...
       get_coded_string_value(programenrolment.observations ->
                           'edf3dc1b-9895-41f1-bfd3-f0e2ad1d667d'::text, concepts.map)::text             as "Enl.Name of place of death",
       get_coded_string_value(
                  programEnrolment.observations -> '(9e0e21b0-e5c2-406a-8da6-a11a78d65329)', concepts.map)::TEXT as "Enl.Timing of death in pregnancy",
       (programEnrolment.observations ->> 'a334f0f7-434d-4acf-b4c2-dff3cb6f454b')::TEXT    as "Enl.Name of reporting person",
       (programEnrolment.observations ->> 'ad31dc43-3c4d-48ff-aae6-194858207f1f')::TEXT    as "Enl.Designation of reporting person",
...
drop view if exists unicef_moha_district_district_form;
...
drop view if exists unicef_moha_district;
